...
blocks:
  ...
  - type: split-image
    compact: true
    subtitle: Still doing the work
    content: |
      ## Experience you can train with

      Great coaching stays practical. Luke continues to demonstrate, drill and refine technique on the gym floor, bringing competitive experience into sessions that students can understand and use.
    button:
